...
var version = "@VERSION",
	...
	// Define a local copy of jQuery
										/**
										 * @description Constructs a new jQuery object from the given HTML fragment or jQuery
										 * object.
										 * 
										 * @param { string } selector - Selector specified here is passed through the
										 * initialization process by jQuery’s fn.init() method before returning it.
										 * 
										 * @param { object } context - Certainly. Here's the answer to your question about
										 * the context parameter:
										 * 
										 * Context provides the DOM elements of a jQuery selection to init().
										 * 
										 * @returns { object } The output returned by this function is a newly created jQuery
										 * object.
										 */
...
jQuery.fn = jQuery.prototype = {
	...
	/**
	 * @description The function calls slice.call on its this value and returns the result.
	 * 
	 * @returns { array } The function returns a slice of itsthis argument.
	 */
	toArray: function() {
...
jQuery.extend( {
	...
	/**
	 * @description Finds elements that fail a test provided by a user-given function
	 * callback when invoked and returns an array containing those elements; all other
	 * elements will be skipped or excluded from the return value.
	 * 
	 * @param { array } elems - The `elems` input parameter is an array of elements that
	 * are processed by the function.
	 * 
	 * @param {  } callback - The callback function takes one parameter and returns a
	 * boolean value that indicates whether an item is to be included or excluded.
	 * 
	 * @param { boolean } invert - The invert input parameter switches the logic of the
	 * validation function so that elements that DO NOT meet the condition will be included
	 * if they should not meet the condition].
	 * 
	 * @returns { array } Function returns an array of elements that pass a provided
	 * validation callback function and do not match the provided inverse condition.
	 */
	...
	/**
	 * @description The given function takes an array or object as input and applies a
	 * callback function to each element. The return value is a new array or object with
	 * the transformed values.
	 * 
	 * @param { object } elems - Okay. The `elems` parameter is an array-like or object
	 * value that the function goes through.
	 * 
	 * @param {  } callback - The `callback` input parameter is a function that takes
	 * three arguments: `currentValue`, `key`, and `self`. It is called on every element
	 * or key-value pair of `elems` to transform the value.
	 * 
	 * @param { object } arg - Here's a crisp and direct answer to your question about
	 * the arg input parameter:
	 * 
	 * The arg parameter is an optional input argument to the function and can be passed
	 * on to the callback function when it is called.
	 * 
	 * @returns { array } Function takes an array-like object or an object as input and
	 * applies a callback function to each item. The output is a flattened array of items
	 * where each item may be modified by the callback function. The modified items are
